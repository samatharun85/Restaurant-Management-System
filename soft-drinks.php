...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="soft drinks.css">
    </head>
    <body>
        <h2 class="cat-title  text-center">SOFT DRINKS</h2>
        <div class="table-container table-responsive">
         <table class="table table-borderless table-dark table-hover">
            <thead>
             ...
             <tbody>
               <form action="menu5.php" method="get">
            <tr>
                <td>SPRITE 750ML</td>
                <td>40/-</td>
                <td><button class="btn" type="button" onclick="decrement()">-</button>
                    <input id=demoInput type=number min=0 max=100 name="sprite">
            ...
            <tr>
                ...
                <td><button class="btn" type="button" onclick="decrement1()">-</button>
                    <input id=demoInput1 type=number min=0 max=100 name="cola">
                ...
                <td>THUMPSUP 750ML</td>
                <td>40/-</td>
                <td><button class="btn" type="button" onclick="decrement2()">-</button>
                    <input id=demoInput2 type=number min=0 max=100 name="thumpsup">
                ...
                <td><button class="btn" type="button" onclick="decrement3()">-</button>
                    <input id=demoInput3 type=number min=0 max=100 name="sting">
