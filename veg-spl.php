...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="veg spl.css">
    </head>
    <body>
        <h2 class="cat-title  text-center">VEG SPECIALS</h2>
        <div class="table-container table-responsive">
         <table class="table table-borderless table-dark table-hover">
            <thead>
             ...
             <tbody>
               <form action="menu4.php" method="get">
               <tr>
                  <td>VEG BIRYANI</td>
                  <td>120/-</td>
                  <td><button class="btn" type="button" onclick="decrement1()">-</button>
                     <input id=demoInput1 type=number min=0 max=100 name="vegbiryani">
               ...
               <tr>
                  ...
                  <td><button class="btn" type="button" onclick="decrement()">-</button>
                     <input id=demoInput type=number min=0 max=100 name="planerice">
                  ...
                  <td><button class="btn" type="button" onclick="decrement2()">-</button>
                     <input id=demoInput2 type=number min=0 max=100 name="tomatocurry">
                  ...
                  <td><button class="btn" type="button" onclick="decrement3()">-</button>
                     <input id=demoInput3 type=number min=0 max=100 name="mixedvegcurry">
