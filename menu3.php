   ...
   <body>
    ...
    <div class="container" >
        ...
        <?php
                ...
                $aroti=$_GET['chickenbiryani'];
                $broti=$_GET['muttonbiryani'];
                $croti=$_GET['butterchicken'];
                $droti=$_GET['greenchicken'];
                $e=$_GET['hidden'];
                ...
                $query2="INSERT INTO nonveg(chickenBiryani,MuttonBiryani,butterChicken,greenChicken,id) VALUES('$aroti','$broti','$croti','$droti','$e');";
