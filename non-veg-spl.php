...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="non-veg spl.css">
    </head>
    <body>
        <h2 class="cat-title  text-center">NON-VEG SPECIALS</h2>
             ...
             <form action="menu3.php" method="get">
               <tr>
                  ...
                  <td>
                     ...
                     <input id=demoInput type=number min=0 max=100 name="chickenbiryani">
               ...
               <tr>
                  ...
                  <td><button class="btn" type="button" onclick="decrement1()">-</button>
                     <input id=demoInput1 type=number min=0 max=100 name="muttonbiryani">
                  ...
                  <td><button class="btn" type="button" onclick="decrement2()">-</button>
                     <input id=demoInput2 type=number min=0 max=100 name="butterchicken">
                  ...
                  <td><button class="btn" type="button" onclick="decrement3()">-</button>
                     <input id=demoInput3 type=number min=0 max=100 name="greenchicken">
